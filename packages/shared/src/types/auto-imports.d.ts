...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { FetchOptions } from './config'
  import('./config')
  // @ts-ignore
  export type { UID, User, UserBio, UserInfo, PicInfo, CardInfo, Meta, Post, Retweet, Comment, PostMeta, PostData, Album } from './post'
  import('./post')
  // @ts-ignore
  export type { Protocol, ProtocolMap } from './protocol'
  import('./protocol')
  // @ts-ignore
  export type { MethodObj, IAccessor, FetchReturn, ParseResult } from './index'
  import('./index')
}
